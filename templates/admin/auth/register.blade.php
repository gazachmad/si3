...
@section('pagestyle')
<link rel="stylesheet" type="text/css" href="{{base_url('template/app-assets/css/plugins/forms/form-validation.css')}}">
<link rel="stylesheet" type="text/css" href="{{base_url('template/app-assets/css/pages/page-auth.css')}}">
@endsection
...
<div class="auth-wrapper auth-v2">
    <div class="auth-inner row m-0">
        ...
        <div class="d-none d-lg-flex col-lg-8 align-items-center p-5">
            <div class="w-100 d-lg-flex align-items-center justify-content-center px-5"><img class="img-fluid" src="{{base_url('template/app-assets/images/pages/register-v2.svg')}}" alt="Register V2" /></div>
        </div>
        <!-- /Left Text-->
        <!-- Register-->
...
@section('pagescript')
<script src="{{base_url('template/app-assets/vendors/js/forms/validation/jquery.validate.min.js')}}"></script>
@endsection

@section('script')
<script src="{{base_url('template/app-assets/js/scripts/pages/page-auth-login.js')}}"></script>
@endsection